...
const ListadoHistorialVentas = () => {
  ...
  const [timeoutId, setTimeoutId] = useState(null); // Estado para el ID del timeout
  ...
  useEffect(() => {
    cargarVentas();
  }, [pagina, columnaOrden, orden, filtroDNI, mostrarDeudas, fechaInicio, fechaFin]);
  ...
  useEffect(() => {
    ...
    return () => clearTimeout(newTimeoutId); // Limpiar el timeout al desmontar
  }, [filtroDNI]);
