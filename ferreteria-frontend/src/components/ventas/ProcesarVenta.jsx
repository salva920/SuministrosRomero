...
import { 
  ...
  Select, MenuItem, Box, Chip, Tabs, Tab, IconButton, InputAdornment, Alert, Snackbar
} from '@mui/material';
import { 
  AddShoppingCart, Delete, Inventory, Dashboard, VpnKey 
...
const ProcesarVenta = () => { 
  ...
  const calcularGanancias = (productos) => {
    return productos.map(producto => ({
      ...producto,
      gananciaUnitaria: producto.precioVenta - producto.costoFinal,
      gananciaTotal: (producto.precioVenta - producto.costoFinal) * producto.cantidad
    }));
  };
